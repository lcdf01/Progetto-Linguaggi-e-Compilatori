-- File: Test.hs -- QUESTA È LA VERSIONE CORRETTA - PER FAVORE, USA QUESTA.
        ...
        Right ast -> do
            ...
            case typeCheckProgram ast of
                ...
                Right finalEnv -> do
                    ...
                    -- Chiama 'genProgram' con l'AST spacchettato per ottenere la funzione,
                    -- poi applica la funzione a 'finalEnv' per ottenere il Program finale.
                    let tacProgFunc = genProgram (A.value ast)
                    let tacProg = tacProgFunc finalEnv
